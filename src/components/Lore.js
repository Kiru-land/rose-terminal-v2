...
const loreData = [
  ...
  { artPath: 'forestbase.txt', text: "", color: 'rgba(255, 255, 255, 1)' },
  ...
  { artPath: 'empty.txt', text: "30 years ago, the first great factions started to emerge, driven by a burning desire of freedom and acceleration.", color: 'rgba(255, 255, 255, 1)' },
    ...
    { artPath: 'bigrosecity.txt', text: "", color: 'rgba(255, 255, 255, 1)' },
    { artPath: 'buildings.txt', text: "", color: 'rgba(255, 255, 255, 1)' },
